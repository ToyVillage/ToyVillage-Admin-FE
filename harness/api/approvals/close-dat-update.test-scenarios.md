...
- 기대 결과: PUT 요청 횟수 1회, pending 중 버튼 disabled와 `저장 중`,
  완료 후 목록으로 이동
...
## 2026-09-17 변경 (#93 퍼블리싱)

- 휴관일 수정 화면 버튼 문구가 Figma `1:7062`에 맞춰 `수정하기`→`저장하기`, 요청 중 `수정 중`→`저장 중`으로 바뀌었다. API 동작 변경 없음.
