...
- Resolved page: `https://app.notion.com/p/6277a4d6147483fcb3f581afe5440232`
- Requested page: `https://app.notion.com/p/6277a4d6147483fcb3f581afe5440232`
...
| --- | --- | --- | --- | --- |
| `OPEN_TIME_UPDATE` | 운영 시간 수정 기능 | `PUT` | `/open-time/{open-time-id}` | `application/json` |
...
| `open-time-id` | integer | true | false | `1` | positive integer, `OPEN_TIME_QUERY_BY_DATE` 응답 `id` |
...
| `startOpenTime` | string | true | false | 예시 참고 | `HH:mm` |
| `endOpenTime` | string | true | false | 예시 참고 | `HH:mm`, 시작보다 늦음(화면 검증) |
