# API Contract — DASHBOARD_COUNT_QUERY
...
- Resolved page: https://app.notion.com/p/c0f7a4d61474827ab9f201e2081498d7
- Requested page: 없음
...
| --- | --- | --- | --- | --- | --- |
| DASHBOARD_COUNT_QUERY | 대시보드 주간 집계 조회 | 이번 주 급여일지·신규 개체·업무보고·업무일지 건수를 조회하는 기능 | GET | /dashboard/count | application/json |
...
### HTTP 200 — 주간 집계 (이번 주 일요일 00:00 이상 ~ 다음 주 일요일 00:00 미만)

| Name | Type | Required | Nullable | Default | Example | Description |
| --- | --- | --- | --- | --- | --- | --- |
| `feedLogCount` | integer | true | false | 없음 | `24` | 이번 주 급여일지 건수 |
| `animalCount` | integer | true | false | 없음 | `3` | 이번 주 신규 개체 건수 |
| `workReportCount` | integer | true | false | 없음 | `12` | 이번 주 업무보고 건수 |
| `workLogCount` | integer | true | false | 없음 | `8` | 이번 주 업무일지 건수 |
