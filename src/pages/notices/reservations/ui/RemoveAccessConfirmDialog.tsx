...
// 페이지 권한 직원 제거 확인 모달(Figma 3551:4566). 공용 DeleteConfirmationDialog와
// 카피·아이콘은 같지만 이 화면은 컴팩트한 버튼(100x48, radius8) 디자인을 쓴다.
  ...
  return createPortal(
    <Overlay>
      <Dialog
        ...
        aria-busy={pending}
      >
        <Icon src={warningIcon} alt="" aria-hidden="true" />
...
const Dialog = styled.div`
  display: flex;
  width: min(calc(100% - 20px * 2), 600px);
