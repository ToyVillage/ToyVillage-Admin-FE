---
feature: open-time-update
api_id: OPEN_TIME_UPDATE
target_page: src/pages/notices/guide/OperatingHoursPage.tsx
notion_page: https://app.notion.com/p/6277a4d6147483fcb3f581afe5440232
...
휴관일 관리의 날짜별 영업시간 화면(Figma yot `1:7101`)에서 `저장하기`로 영업시간을 저장한다.  `OPEN_TIME_UPDATE`를 호출한다.
